...
# allPopStatistics = pd.DataFrame(results_list, columns=['Ne', 'Gametic_disequilibrium','Emean_exhyt','Fix_index','Mlocus_homozegosity_mean','Mlocus_homozegosity_variance'])
inputStatsList = pd.DataFrame([inputStatsList], columns=['Gametic_disequilibrium','Emean_exhyt','Fix_index','Mlocus_homozegosity_mean','Mlocus_homozegosity_variance'])
Z = np.array(inputStatsList[['Gametic_disequilibrium','Emean_exhyt','Fix_index','Mlocus_homozegosity_mean','Mlocus_homozegosity_variance']])
# X = np.array(allPopStatistics[['Gametic_disequilibrium','Emean_exhyt','Fix_index','Mlocus_homozegosity_mean','Mlocus_homozegosity_variance']])
...
ridge_model = load('ridge_200.joblib')
