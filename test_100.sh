...
folder="/blue/boucher/suhashidesilva//ONeSAMP_3.1/ONeSAMP_3/data"
output="/blue/boucher/suhashidesilva/ONeSAMP_3.1/ONeSAMP_3/output"
...
for file in "$folder"/*; do
    if [ -f "$file" ]; then
        ...
        python /blue/boucher/suhashidesilva/ONeSAMP_3.1/ONeSAMP_3/main.py --s 20000 --o "$file" > "$output_file"
